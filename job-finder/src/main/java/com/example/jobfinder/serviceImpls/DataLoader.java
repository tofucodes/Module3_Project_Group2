...
public class DataLoader {
    ...
    public void loadData() {
        ...
        jobRepository.save(new Job("Manager", "Maintains staff by recruiting, selecting, orienting, and training employees. Ensures a safe, secure, and legal work environment.", "Supervisors & Managers", 100000, 30, "Singapore"));
        jobRepository.save(new Job("Housewife", "A housewife (also known as a homemaker) is a woman whose work is running or managing her family's home", null, 0, 30, "Singapore"));
        ...
        jobRepository.save(new Job("Student", "Study", null, 0, 0, "Singapore"));
